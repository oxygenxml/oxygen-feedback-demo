...
tools/oxygen-publishing-engine-3.x/bin/dita -i dita/mobile-phone/mobilePhone.ditamap -filter=dita/mobile-phone/ditaval/x1000.ditaval -f webhelp-responsive -o output/mobile-phone/1.0/ -t temp/mobile-phone/1.0 -Dwebhelp.publishing.template.descriptor=hightech.opt -Dwebhelp.publishing.template=publishing/hightech/

tools/oxygen-publishing-engine-3.x/bin/dita -i dita/mobile-phone/mobilePhone.ditamap -filter=dita/mobile-phone/ditaval/x2000.ditaval -f webhelp-responsive -o output/mobile-phone/2.0/ -t temp/mobile-phone/2.0 -Dwebhelp.publishing.template.descriptor=hightech.opt -Dwebhelp.publishing.template=publishing/hightech/