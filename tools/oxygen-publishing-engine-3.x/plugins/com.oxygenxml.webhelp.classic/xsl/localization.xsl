...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="generateLocalizationFiles">
        ...
        <!-- WebHelp Feedback module needs strings.js to be in RequireJS format -->
        <xsl:if test="lower-case($WEBHELP_FEEDBACK_ENABLED)='true'">
            <xsl:variable name="jsFileName" select="'oxygen-webhelp/resources/localization/requirejs_strings.js'"/>
