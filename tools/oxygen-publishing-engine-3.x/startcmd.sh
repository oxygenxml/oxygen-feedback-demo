...
NEW_CLASSPATH="$DITA_DIR/lib/icu4j-69_1.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/logback-classic-1.2.6.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/logback-core-1.2.6.jar:$NEW_CLASSPATH"
